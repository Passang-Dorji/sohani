...
export default function Navbar() {
	...
	return (
		<div>
			<nav className="bg-gradient-to-br z-50 from-purple-500 via-indigo-400 to-pink-300 opacity-75 border-gray-200">
						...
						<ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-pink-500 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-purple-800 md:dark:bg-purple-900 dark:border-pink-700">
							...
							<li className="relative">
								<button
									...
									className="flex items-center justify-between w-full py-2 px-3 text-black hover:bg-pink-500 md:hover:bg-green-500 md:border-0 md:hover:text-blue-700 md:p-0 md:w-auto dark:text-white md:dark:hover:text-blue-500 dark:focus:text-white dark:hover:bg-purple-700 md:dark:hover:bg-transparent"
								>
									Dropdown
									<svg
								...
								<div
									...
									} font-normal bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44 dark:bg-green-700 dark:divide-gray-600`}
								>
									<ul
										...
										<li>
											...
											<div
												...
												className={`absolute z-50 left-full top-0 ml-1 ${
													showDoubleDropdown ? "block" : "hidden"
